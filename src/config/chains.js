...
export const SUPPORTED_CHAINS = {
  ETHEREUM: {
    ...
    symbol: "ETH",
    chain: mainnet,
    rpcUrl: "https://eth-mainnet.g.alchemy.com/v2/HMY8NYYFL2K15hNmFFxK3",
  ...
  POLYGON: {
    ...
    chain: polygon,
    alchemyUrl:
      "https://polygon-mainnet.g.alchemy.com/v2/HMY8NYYFL2K15hNmFFxK3",
  ...
  BSC: {
    ...
    alchemyUrl: "https://bnb-mainnet.g.alchemy.com/v2/HMY8NYYFL2K15hNmFFxK3",
  ...
  ARBITRUM: {
    ...
    symbol: "ETH",
    chain: arbitrum,
    rpcUrl: "https://arb-mainnet.g.alchemy.com/v2/HMY8NYYFL2K15hNmFFxK3",
  ...
  OPTIMISM: {
    ...
    symbol: "ETH",
    chain: optimism,
    rpcUrl: "https://opt-mainnet.g.alchemy.com/v2/HMY8NYYFL2K15hNmFFxK3",
  ...
  AVALANCHE: {
    ...
    alchemyUrl: "https://avax-mainnet.g.alchemy.com/v2/HMY8NYYFL2K15hNmFFxK3",
